<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Sidebar3.ascx.cs" Inherits="Sidebar" %>
...
<div class="sidebar-menu">
    <ul>
        <li><a href="Tdash.aspx" class="<%= currentPage == "Tdash.aspx" ? "active" : "" %>"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
          <li><a href="theology.aspx" class="<%= currentPage == "theology.aspx" ? "active" : "" %>"><i class="fas fa-chart-bar"></i>Score</a></li>
       
        <li><a href="fscores.aspx" class="<%= currentPage == "fscores.aspx" ? "active" : "" %>"><i class="fas fa-dollar-sign"></i>#Scores</a></li>
        <li><a href="Tanaly.aspx" class="<%= currentPage == "Tanaly.aspx" ? "active" : "" %>"><i class="fas fa-chart-line"></i>Moving Average</a></li>
        <li><a href="Twek.aspx" class="<%= currentPage == "Twek.aspx" ? "active" : "" %>"><i class="fas fa-calendar-week"></i>Weekly Score</a></li>
          <li><a href="TSchoolTrend.aspx" class="<%= currentPage == "TSchoolTrend.aspx" ? "active" : "" %>"><i class="fas fa-pie-chart"></i>Schools Trend</a></li>
        <li><a href="Tmanage.aspx" class="<%= currentPage == "Tmanage.aspx" ? "active" : "" %>"><i class="fas fa-cog"></i>Manage Areas</a></li>
