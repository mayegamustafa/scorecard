<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Adwek.aspx.cs" Inherits="wek" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="content">
            <div class="container1">
                <a href="administration.aspx" class="add-score"><i class="fas fa-plus"></i> Add Score</a>
            ...
            <div class="chart-container">
                <h3 id="lblRankHeader1" runat="server">Average Chart</h3>
                <div class="chart-container">
                    <asp:Chart ID="SchoolScoresChart" runat="server" Width="1400px" Height="500px">
                        <Series>
            ...
            <br />
            <asp:GridView ID="GridView1" runat="server" DataSourceID="tst"></asp:GridView>
    ...
    <script>
        window.addEventListener('resize', function () {
            var chart = document.querySelector('.chart-container canvas');
            if (chart) {
