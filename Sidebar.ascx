...
<div class="sidebar-menu">
    <ul>
        <li><a href="fdash.aspx" class="<%= currentPage == "fdash.aspx" ? "active" : "" %>"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        <li><a href="finance.aspx" class="<%= currentPage == "finance.aspx" ? "active" : "" %>"><i class="fas fa-chart-bar"></i>Score</a></li>
        <li><a href="fscores.aspx" class="<%= currentPage == "fscores.aspx" ? "active" : "" %>"><i class="fas fa-dollar-sign"></i>#Scores</a></li>
        <li><a href="fanaly.aspx" class="<%= currentPage == "fanaly.aspx" ? "active" : "" %>"><i class="fas fa-chart-line"></i>Moving Average</a></li>
        <li><a href="fwek.aspx" class="<%= currentPage == "fwek.aspx" ? "active" : "" %>"><i class="fas fa-calendar-week"></i>Weekly Score</a></li>
          <li><a href="fSchoolTrend.aspx" class="<%= currentPage == "fSchoolTrend.aspx" ? "active" : "" %>"><i class="fas fa-pie-chart"></i>Schools Trend</a></li>
        <li><a href="fmanage.aspx" class="<%= currentPage == "fmanage.aspx" ? "active" : "" %>"><i class="fas fa-cogs"></i>Manage Areas</a></li>
        <li><a href="ChatSelection.aspx" class="<%= currentPage == "ChatSelection.aspx" ? "active" : "" %>"><i class="fas fa-cogs"></i>Messages</a></li>
