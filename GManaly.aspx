<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GManaly.aspx.cs" Inherits="GManaly" %>
 ...
 - SAK Scorecard</h1>
        ...
        <div class="content">
            ...
            <div class="container2">
                <h2>Overall Moving Average Scores</h2>
            ...
            <h2>Overall Moving Average  Score Chart</h2>
            <div class="chart-container">
                <asp:Chart ID="ScoresChart" runat="server" Width="1600px" Height="1000px" CssClass="chart-container">
                    <ChartAreas>
