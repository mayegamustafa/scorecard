<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Sidebar5.ascx.cs" Inherits="Sidebar" %>
...
<div class="sidebar-menu">
    <ul>
        <li><a href="Addash.aspx" class="<%= currentPage == "Addash.aspx" ? "active" : "" %>"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        <li><a href="administration.aspx" class="<%= currentPage == "administration.aspx.aspx" ? "active" : "" %>"<i class="fas fa-chart-bar"></i>Score</a></li>
        <li><a href="fscores.aspx" class="<%= currentPage == "fscores.aspx" ? "active" : "" %>"><i class="fas fa-dollar-sign"></i>#Scores</a></li>
        <li><a href="Adanaly.aspx" class="<%= currentPage == "Adanaly.aspx" ? "active" : "" %>"><i class="fas fa-chart-line"></i>Moving Average</a></li>
        <li><a href="Adwek.aspx" class="<%= currentPage == "Adwek.aspx" ? "active" : "" %>"><i class="fas fa-calendar-week"></i>Weekly Score</a></li>
          <li><a href="AdSchoolTrend.aspx" class="<%= currentPage == "AdSchoolTrend.aspx" ? "active" : "" %>"><i class="fas fa-pie-chart"></i>Schools Trend</a></li>
        <li><a href="Admanage.aspx" class="<%= currentPage == "Admanage.aspx" ? "active" : "" %>"><i class="fas fa-cog"></i>Manage Areas</a></li>
