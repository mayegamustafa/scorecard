<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Sidebar2.ascx.cs" Inherits="Sidebar" %>
...
<div class="sidebar-menu">
    <ul>
        <li><a href="Adash.aspx" class="<%= currentPage == "Adash.aspx" ? "active" : "" %>"><i class="fas fa-tachometer-alt"></i>Dashboard</a></li>
        <li><a href="academic.aspx" class="<%= currentPage == "academic.aspx" ? "active" : "" %>"><i class="fas fa-chart-bar"></i>Score</a></li>
        <li><a href="fscores.aspx" class="<%= currentPage == "fscores.aspx" ? "active" : "" %>"><i class="fas fa-dollar-sign"></i>#Scores</a></li>
        <li><a href="Aanaly.aspx" class="<%= currentPage == "Aanaly.aspx" ? "active" : "" %>"><i class="fas fa-chart-line"></i>Moving Average</a></li>
        <li><a href="Awek.aspx" class="<%= currentPage == "Awek.aspx" ? "active" : "" %>"><i class="fas fa-calendar-week"></i>Weekly Score</a></li>
          <li><a href="ASchoolTrend.aspx" class="<%= currentPage == "ASchoolTrend.aspx" ? "active" : "" %>"><i class="fas fa-pie-chart"></i>Schools Trend</a></li>
        <li><a href="Amanage.aspx" class="<%= currentPage == "Amanage.aspx" ? "active" : "" %>"><i class="fas fa-cog"></i>Manage Areas</a></li>
        <li><a href="AChatSelection.aspx" class="<%= currentPage == "AChatSelection.aspx" ? "active" : "" %>"><i class="fas fa-cogs"></i>Messages</a></li>
