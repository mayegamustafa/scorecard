...
public partial class GMwek : System.Web.UI.Page
{
    ...
    private void LoadGridViewsAndChartData()
    {
     ...
     //   string userDepartment = GetLoggedInUserDepartment();
       // string prefix = GetDepartmentPrefix(userDepartment);
        ...
        lblVarianceHeader.InnerText = previousWeekNumber < 1 ? "Overall Variance - Week 1" : "Overall Variance - Week " + previousWeekNumber + " vs Week " + selectedWeekNumber;
        lblVarianceHeader1.InnerText = " Overall Variance - " + selectedWeek;
        lblRankHeader.InnerText = " Overall Rank  - " + selectedWeek;
        lblRankHeader1.InnerText = "Overall Percentage Chart - " + selectedWeek;

       // string pivotedViewName = prefix + "week" + selectedWeekNumber + "_pivoted_view_" + selectedTerm + "_" + selectedYear;
        string varianceViewName = previousWeekNumber < 1 ? null :  "variance_view_week" + selectedWeekNumber + "_vs_week" + previousWeekNumber + "_" + selectedTerm + "_" + selectedYear;
        string rankViewName = "summary_ranks_view_week" + selectedWeekNumber + "_" + selectedTerm + "_" + selectedYear;
